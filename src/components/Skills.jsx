...
import { FaHtml5, FaCss3Alt, FaJsSquare, FaJava, FaPython, FaFigma, FaGitAlt, FaGithub, FaReact, FaSass } from "react-icons/fa";
        ...
        <div id="skills">
            ...
            <div className="language gradient_text">
                ...
                <div className="box_1">
                    ...
                    <span><FaPython size="2em" color="#fed142" aria-hidden="true" /></span>
                </div>
            </div>
            <div className="tools gradient_text">
                ...
                <div className="box_2">
                    ...
                    <span><SiGimp size="2em" color="#fff" aria-hidden="true" /></span>
                    <span><SiInkscape size="2em" color="#fff" aria-hidden="true" /></span>
